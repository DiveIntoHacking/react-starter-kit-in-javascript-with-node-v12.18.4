...
以下の手順でアプリケーションを起動できます。
    ...
    $ wget https://github.com/DiveIntoHacking/react-starter-kit-in-typescript-with-node-v12.18.4/archive/v1.0.tar.gz
    $ tar zxvf v1.0.tar.gz
    $ cd react-starter-kit-in-typescript-with-node-v12.18.4-1.2
    $ yarn install
    $ yarn start
...
## アプリケーションの起動方法(Dockerを使用する場合)
    ...
    $ wget https://github.com/DiveIntoHacking/react-starter-kit-in-typescript-with-node-v12.18.4/archive/v1.0.tar.gz
    $ tar zxvf v1.0.tar.gz
    $ cd react-starter-kit-in-typescript-with-node-v12.18.4-1.1
    $ touch .bash_history
